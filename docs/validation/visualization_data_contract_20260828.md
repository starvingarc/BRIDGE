...
| Validated implementation commit | `f176bcf39fd12b0fbeb667fe8d52264c8b7d8ec2` |
| Python | `3.12.13` |
| Wheel | `bridge-0.2.0.dev0-py3-none-any.whl` |
| Wheel SHA-256 | `ad0d4111dfb695bccb549bfe46d55d3c758a13375d650d3c43782bcee0c22929` |

The wheel was built from the implementation commit on the authorized server,
installed without the source tree on the import path, and imported from the
...
| Gate | Result |
|---|---|
| Visualization contract, Schema, CLI and SDK suite | `43 passed` |
| Complete repository suite | `1349 passed, 20 warnings` |
...
- incomplete intervals or denominators, missing evidence without reason codes,
  private filesystem references and render/data hash drift fail closed;
- the public Draft 2020-12 Schemas enforce the same structural constraints;
- the registry resolves the seven existing P0-01/P0-02 IDs but refuses to treat
  them as typed candidates.
