...
- Module tests: `PYTHONPATH=src .../.venv/bin/python -m pytest -q tests/test_p0_08_evidence_sufficiency.py` — 425 passed after seven independent-review hardening passes.
...
- Full source suite after rebasing onto the reviewed shared runtime: 690 passed with three pre-existing scientific-library warnings.
