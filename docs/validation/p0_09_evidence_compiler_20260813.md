...
Observed after the 2026-08-14 final review fix set on Python 3.12.13 with the shared development environment's PyArrow 23.0.1 and NetworkX 3.6.1: `177 passed`.

Current source-tree observations:

- the complete source-tree suite passed: `867 passed, 3 warnings`;
