...
|---|---|---|
| Review the approved result experience and figure system | [Visualization system](visualization.md) | [Scientific task cards](bridge_spec_v0.1/README.md) · [high-level contract](tool-contract.md) |
