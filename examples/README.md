...
- `requests/p0_03_target_regional_evidence.json`: eleven-object P0-03 candidate request shape. It consumes a P0-02 V3 profile plus exact measurement, vocabulary, reference, QC and lineage objects; all paths and checksums are placeholders.
