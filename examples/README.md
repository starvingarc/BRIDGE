...
| P0-06 | [`p0_06_process_method_runtime.json`](requests/p0_06_process_method_runtime.json) | Exact DataView H5AD, external program/state/unit contracts and required gate-facing MeasurementSpec; normalized expression or raw counts are accepted |
