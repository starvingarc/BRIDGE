...
MODELS = {
    ...
    "benchmark_split_manifest": ("bridge://schemas/benchmark-split-manifest/v0.1", BenchmarkSplitManifest),
    "biological_review_record": ("bridge://schemas/biological-review-record/v0.1", BiologicalReviewRecord),
    "cell_state_benchmark_spec": ("bridge://schemas/cell-state-benchmark-spec/v0.1", CellStateBenchmarkSpec),
    ...
    "freeze_gate_spec": ("bridge://schemas/freeze-gate-spec/v0.1", FreezeGateSpec),
