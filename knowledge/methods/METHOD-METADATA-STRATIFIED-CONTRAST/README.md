# Metadata-stratified contrast

| Field | Value |
|---|---|
| Method ID | `METHOD-METADATA-STRATIFIED-CONTRAST` |
| Modules | P0-06 |
...
Duration, temperature range, medium, agitation and receipt time

## Outputs

Transport context and evidence availability

## Boundaries

No causal attribution without separable design
