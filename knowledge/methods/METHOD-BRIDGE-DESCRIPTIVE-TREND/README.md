# BRIDGE descriptive trend

| Field | Value |
|---|---|
| Method ID | `METHOD-BRIDGE-DESCRIPTIVE-TREND` |
| Modules | P0-04 |
...
At least two ordered true timepoints

## Outputs

trajectory of raw proportions/programs with no p-value
