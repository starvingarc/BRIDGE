# csv + deterministic rule

| Field | Value |
|---|---|
| Method ID | `METHOD-CSV-DETERMINISTIC-RULE` |
| Modules | P0-11 |
...
CSV formula injection | formula-trigger policy on every string cell
...
leading equals/plus/minus/at after whitespace
