# BRIDGE sample/preparation aggregator

| Field | Value |
|---|---|
| Method ID | `METHOD-BRIDGE-SAMPLE-PREPARATION-AGGREGATOR` |
| Modules | P0-04 |
...
Explicit D/Stage, sample, preparation and replicate hierarchy

## Outputs

per-timepoint composition/program table
