# Visualization Registry + regex

| Field | Value |
|---|---|
| Method ID | `METHOD-VISUALIZATION-REGISTRY-REGEX` |
| Modules | P0-11 |
...
tooltip payload | field allowlist + hidden payload scan

## Outputs

VisualizationCheckRecord

## Boundaries

sample IDs; extra metadata columns
