# BRIDGE regional pseudobulk correlation

| Field | Value |
|---|---|
| Method ID | `METHOD-BRIDGE-REGIONAL-PSEUDOBULK-CORRELATION` |
| Modules | P0-03 |
...
| Evidence family | regional_similarity |
...
sample/state pseudobulk

## Outputs

region correlation + margin
