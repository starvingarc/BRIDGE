# Registered preprocessing swap

| Field | Value |
|---|---|
| Method ID | `METHOD-REGISTERED-PREPROCESSING-SWAP` |
| Modules | P0-07 |
...
Frozen alternative preprocessing views

## Outputs

Metric/claim changes by preprocessing

## Boundaries

Cannot choose the most favorable output
