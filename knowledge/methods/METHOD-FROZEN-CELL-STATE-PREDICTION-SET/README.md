# Frozen Cell-State prediction set

| Field | Value |
|---|---|
| Method ID | `METHOD-FROZEN-CELL-STATE-PREDICTION-SET` |
| Modules | P0-06 |
...
CellStateEvidenceProfile with unknown and disagreement

## Outputs

Soft/hard candidate counts and identity uncertainty

## Boundaries

Cell identity prediction alone cannot prove residual undifferentiated cells
