...
The generated [active-methods shortlist](active-methods.md) shows only the methods selected by P0-01, P0-02, P0-03, P0-08 and P0-09. The repository does not track exploded Method Cards, Source Cards, bindings, aliases, retrieval chunks or source URL lists.
