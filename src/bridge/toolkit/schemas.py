...
SCHEMA_REFS = {
    ...
    "bridge://schemas/comparison-evidence-bundle/v0.1": "comparison_evidence_bundle.schema.json",
    "bridge://schemas/comparison-record/v0.1": "comparison_record.schema.json",
    "bridge://schemas/comparison-spec/v0.1": "comparison_spec.schema.json",
    ...
    "bridge://schemas/graft-assessment/v0.1": "graft_assessment.schema.json",
    ...
    "bridge://schemas/graft-lineage-manifest/v0.1": "graft_lineage_manifest.schema.json",
    ...
    "bridge://schemas/off-target-role-spec/v0.1": "off_target_role_spec.schema.json",
    "bridge://schemas/off-target-control-result/v0.1": "off_target_control_result.schema.json",
    "bridge://schemas/program-assessment-spec/v0.1": "program_assessment_spec.schema.json",
    ...
    "bridge://schemas/review-projection-spec/v0.1": "review_projection_spec.schema.json",
    "bridge://schemas/contract-validated-review-projection/v0.1": (
        "contract_validated_review_projection.schema.json"
    ),
