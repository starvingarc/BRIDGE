...
SCHEMA_REFS = {
    ...
    "bridge://schemas/benchmark-split-manifest/v0.1": "benchmark_split_manifest_v0.1.schema.json",
    ...
    "bridge://schemas/cell-state-benchmark-spec/v0.1": "cell_state_benchmark_spec_v0.1.schema.json",
    ...
    "bridge://schemas/freeze-gate-spec/v0.1": "freeze_gate_spec_v0.1.schema.json",
