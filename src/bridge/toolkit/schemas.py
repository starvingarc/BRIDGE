...
SCHEMA_REFS = {
    ...
    "bridge://schemas/benchmark-split-manifest/v0.1": "benchmark_split_manifest.schema.json",
    "bridge://schemas/biological-review-record/v0.1": "biological_review_record.schema.json",
    "bridge://schemas/cell-state-benchmark-spec/v0.1": "cell_state_benchmark_spec.schema.json",
    ...
    "bridge://schemas/freeze-gate-spec/v0.1": "freeze_gate_spec.schema.json",
