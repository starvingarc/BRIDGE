...
- [ ] Verify actual registered execution and literal expected values/denominators for the constructed inputs, including legitimate partial/unavailable results. Preserve canonical measured versus exploratory boundaries.
- [ ] Verify deterministic reuse, admission/resource counters, provenance drift and no post-stop continuation. Run focused Web input/scientific/coordinator integration suites, self-review and commit this task only.
- [ ] Report the exact automatic mode pairs, manual-only modes, canonical measurement artifacts and remaining prerequisites for the Task 4/5 handoff.
...
**Interfaces and requirements:**
- Consume Task 3's actual canonical producer outputs and approved root closure; do not reimplement scientific input constructors or introduce another coordinator/generic profile executor.
