...
- Successful or partial v0.2 runs must preserve request, tool version, implementation state and result-schema bindings.
- Existing v0.1 models and schema files remain unchanged.

## Acceptance evidence

- [x] Baseline: `192 passed, 3 warnings` before edits.
- [x] Full source suite: `217 passed, 3 warnings`.
...
- [x] Repository policy and public/packaged schema parity: passed.
