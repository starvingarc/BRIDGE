...
- Post-adapter hash checks run on success, invalid returns and exceptions; mutation takes precedence as `input_asset_modified_during_run`, while unrelated unchanged-input failures propagate.
- Scaffold and deprecated packages are consistently non-executable across v0.1 and v0.2.
...
- [x] Diff whitespace and explicit v0.1 schema compatibility checks after second review hardening: passed.
- [x] Isolated wheel build passed and contained all four structured-runtime schemas.
