...
| [Repository Readability](repository-readability.md) | Make the public entrypoints and all 12 package documentation paths readable without changing scientific claims | All 12 packages execute, but navigation is fragmented and several current pages contain stale status text | Consolidate navigation, fix documentation drift and validate the exact branch on `/data1` | `in_progress` |
