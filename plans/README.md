...
|---|---|---|---|---|
| [Web Full-Chain Integration](web-full-chain-integration.md) | Connect genuine user data and deterministic tool evidence through staged Web approvals | All twelve tool input/approval routes are implemented; genuine-data acceptance remains partial | Restore source lineage and resolve P0-05 mass / P0-06 unresolved-state contracts; verify real-model conversation fixes | `in_progress` |
