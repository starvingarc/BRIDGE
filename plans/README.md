...
|---|---|---|---|---|
| [Step 7 Evidence Coordinator](step7-evidence-coordinator.md) | Connect evidence-driven cell-state and product assessment | Genuine upload reached QC, candidate cell-state and descriptive cycle evidence; the measured product graph remains blocked | Complete the real measured-feedback gate after applicable scientific inputs are reviewed | `awaiting_scientific_inputs_and_review` |
