...
| [Input Data Quality and Analysis Eligibility Figures](p0-01-input-qc-visualization.md) | Report whether uploaded observations meet defined technical conditions without turning candidate QC flags into a product grade or a global reliability claim | Four typed candidate figures are implemented; realistic `count_ready` uploads are prepared for MacroDiff (78,542 cells) and Studer-protocol D16 (11,087 cells); SphereDiff remains an honest unavailable-input case | Run the two eligible raw-count uploads on the exact server wheel, review figures, then complete independent review of Draft PR #62 | `validation_in_progress` |
