...
|---|---|---|---|---|
| [Web Full-Chain Integration](web-full-chain-integration.md) | Connect genuine user data and deterministic tool evidence through staged Web approvals | The first Web release exposes QC only; real lineage/product context and P0-05 composition projection remain unresolved | Connect truthful candidate stages and acquire the missing source facts before full-chain acceptance | `in_progress` |
