...
| [Data Readiness Visualization](p0-01-input-qc-visualization.md) | Explain whether uploaded observations can support requested analyses without turning candidate QC flags into a product grade | The first question-led family has specified its scientific figures, static publication contract and evidence boundaries; UI work is deferred | Implement and validate the complete “Can this analysis be trusted?” analysis-figure family on the server | `implementation_planned` |
