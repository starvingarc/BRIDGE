...
|---|---|---|---|---|
| [Step 7 Evidence Coordinator](step7-evidence-coordinator.md) | Connect evidence-driven cell-state and product assessment | Scope-bound tool/graph coordination and portrait are integrated; final acceptance and scientific gates remain | Validate real source-bound measurements and the rendered evidence-feedback chain | `in_progress` |
