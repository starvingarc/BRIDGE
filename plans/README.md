...
| [Input Data Quality and Analysis Eligibility Figures](p0-01-input-qc-visualization.md) | Report whether uploaded observations meet defined technical conditions without turning candidate QC flags into a product grade or a global reliability claim | The first user-need-led family has specified its scientific figures, static publication contract and evidence boundaries; UI work is deferred | Implement and validate the complete input-quality and analysis-eligibility figure family on the server | `implementation_planned` |
