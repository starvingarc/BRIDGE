...
| [P0-03 Target and Regional Visualization](p0-03-target-regional-visualization.md) | Show how a product supports declared target roles and named regional reference states | P0-03 has structured ratios and expression evidence but no typed figure artifacts | Implement denominator-aware composition and source-separated reference-support figures | `implementation_in_progress` |
