...
| [Data Readiness Visualization](p0-01-input-qc-visualization.md) | Explain whether uploaded observations can support requested analyses without turning candidate QC flags into a product grade | The first question-led figure family has specified main/supporting figures, desktop/mobile reading order and evidence boundaries | Implement and validate the complete “Can this analysis be trusted?” figure family on the server | `implementation_planned` |
